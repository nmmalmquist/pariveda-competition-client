const GetDogsForBuy = async () => {
  const buyDogsApiUrl =
    "https://pariveda-competition-api.herokuapp.com/api/dog/buy";
  const response = await fetch(buyDogsApiUrl);
  const data = await response.json();
  return data;
};
const GetDogsForRent = async () => {
  const rentDogsApiUrl =
    "https://pariveda-competition-api.herokuapp.com/api/dog/rent";
...
const GetAllDogs = async () => {
  const allDogsApiUrl =
    "https://pariveda-competition-api.herokuapp.com/api/dog/all";
